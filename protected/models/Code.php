 ...
 *
 * The followings are the available columns in table 'qrcodes':
 * @property integer $id
...
class Code extends CActiveRecord
{
	...
	public function uploadQRCode($codeContent,$guest) {
		$qrcodesFolder = 'qrcodes/';
		$filename = 'qrcode_'.$guest.'.png';
		$path = $qrcodesFolder.$filename;
